:: Orginal Script from @mackwage https://gist.github.com/mackwage/08604751462126599d7e52f233490efe 
...
reg add "HKCU\SYSTEM\CurrentControlSet\Policies\EarlyLaunch" /v DriverLoadPolicy /t REG_DWORD /d 7 /f
::
...
:: test here powershell lines could kill script
...
:: Disabling NTDS dump share
net share NTDS$ /delete

:: Enhance the RDP encryption level with TLS :::::::::::::::::::::::::::::
...
:: maybe try  2 or 3 maybe 4
reg add "HKEY_LOCAL_MACHINE\System\CurrentControlSet\Control\Terminal Server\WinStations\RDP-Tcp" /v MinEncryptionLevel /t REG_DWORD /d 3 /f


:: Enabling switch to the secure desktop when prompting for elevation
reg add "HKLM\SOFTWARE\Microsoft\Windows\CurrentVersion\Policies\System" /v "PromptOnSecureDesktop" /t REG_DWORD /d 1 /f

:: Prevent users from installing printer drivers [enabled]
reg add "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\Policies\Explorer" /v "NoAddPrinterDrivers" /t REG_DWORD /d 1 /f
...
:: EDIT THIS TO GET RID OF THE SERVICES NEEDED ON BOXES?
...
reg add "HKLM\SYSTEM\CurrentControlSet\Control\SecurePipeServers\winreg" /v "Remotable" /t REG_DWORD /d 0 /f
:: Restict anonymous access to named pipes and shares
reg ADD HKLM\SYSTEM\CurrentControlSet\services\LanmanServer\Parameters /v NullSessionShares /t REG_MULTI_SZ /d "" /f
:: Allow to use Machine ID for NTLM
reg ADD HKLM\SYSTEM\CurrentControlSet\Control\Lsa /v UseMachineId /t REG_DWORD /d 0 /
:: Disable SMBv1
reg add "HKLM\SYSTEM\CurrentControlSet\Services\LanmanServer\Parameters" /v SMB1 /t REG_DWORD /d 0 /f
...
reg add "HKLM\SOFTWARE\Policies\Microsoft\Windows NT\Terminal Services\Client" /v DisableClipboardRedirection /t REG_DWORD /d 1 /f
:: Disable NetBIOS over TCP/IP
reg add "HKLM\SYSTEM\CurrentControlSet\Services\NetBT\Parameters" /v "EnableDnsSd" /t REG_DWORD /d 0 /f
:: Disable rpc over http proxy
reg add "HKLM\SOFTWARE\Policies\Microsoft\Windows NT\Rpc" /v DisableRpcOverHttp /t REG_DWORD /d 1 /f
:: disable the storage of LM has passwords
reg add "HKLM\SYSTEM\CurrentControlSet\Control\Lsa" /v NoLMHash /t REG_DWORD /d 1 /f
:: DisableExceptionChainValidation - No idea from ORlandos script
reg add "HKLM\SYSTEM\CurrentControlSet\Control\Session Manager\kernel" /v DisableExceptionChainValidation /t REG_DWORD /d 0 /f

:: SMB Passwords unencrypted to third party
reg ADD HKLM\SYSTEM\CurrentControlSet\services\LanmanWorkstation\Parameters /v EnablePlainTextPassword /t REG_DWORD /d 0 /f
:: Require Ctrl+Alt+Delete before seeing the login screen
REG ADD "HKLM\SOFTWARE\Microsoft\Windows\CurrentVersion\Policies\System" /v DisableCAD /t REG_DWORD /d 0 /f

:: Set MaxCachedSockets (REG_DWORD) to 0
reg add "HKLM\SYSTEM\CurrentControlSet\Services\NetBT\Parameters" /v "MaxCachedSockets" /t REG_DWORD /d 0 /f

:: Set SmbDeviceEnabled (REG_DWORD) to 0
reg add "HKLM\SYSTEM\CurrentControlSet\Services\LanmanWorkstation\Parameters" /v "SmbDeviceEnabled" /t REG_DWORD /d 0 /f
